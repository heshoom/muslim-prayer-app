export const translations = {
  ...
  allSet: "You're all set!",
      nextPrayerAt: 'Your next prayer is {prayerName} at {prayerTime}',
  goToHome: 'Go to Home',
  unableToAccessLocation: 'Unable to access location',
    ...
    tour: {
      ...
      qiblaCompass: {
        title: 'Qibla Compass',
        desc: 'Know the direction of the Kaaba from anywhere in the world',
      },
      dailyContent: {
    ...
    // Welcome & Onboarding
    welcomeComplete: 'Welcome to Islamic Pro! You can enable location services later to get prayer times.',
  },
  ...
  finish: 'مکمل',
  allSet: 'سب تیار ہے!',
      nextPrayerAt: 'آپ کی اگلی نماز {prayerName} {prayerTime} بجے ہے',
  ...
  prePrayerReminderDesc: 'ہر نماز سے چند منٹ پہلے یاد دہانی وصول کریں',
    ...
    calculationMethodUpdatedDesc: 'تم تحدیث طریقہ حساب الصلاة تلقائیاً للحصول على دقة أفضل في هذه المنطقة۔',
    apply: 'لاگو کریں',
    calculationMethods: {
  ...
  finish: 'إنهاء',
  allSet: 'تم الإعداد! ',
      nextPrayerAt: 'صلاتك التالية هي {prayerName} الساعة {prayerTime}',
  ...
  finish: 'Bitir',
  allSet: 'Hazırsınız!',
      nextPrayerAt: 'Sonraki namazınız {prayerName} {prayerTime}',
