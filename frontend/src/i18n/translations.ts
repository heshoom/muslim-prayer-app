export const translations = {
  en: {
    ...
    qiblaAngle: 'Qibla',
    qiblaInstructions: 'Hold your phone flat and rotate until the green arrow points up',
  ...
  ar: {
    ...
    qiblaAngle: 'القبلة',
    qiblaInstructions: 'أمسك هاتفك بشكل مسطح ودوره حتى يشير السهم الأخضر إلى الأعلى',
